...
abstract class TextTranslations {
  TextTranslations(String locale)
  ...
  static const LocalizationsDelegate<TextTranslations> delegate =
      _TextTranslationsDelegate();
...
class _TextTranslationsDelegate
    extends LocalizationsDelegate<TextTranslations> {
...
TextTranslations lookupTextTranslations(Locale locale) {
  ...
  switch (locale.languageCode) {
    case 'en':
      return TextTranslationsEn();
    case 'pl':
      return TextTranslationsPl();
  }
